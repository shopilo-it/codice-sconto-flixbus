#!/usr/bin/env python3
"""
Recupero codici sconto FlixBus da shopilo.it
Sursa: https://shopilo.it/negozi/flixbus.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/flixbus.it"
STORE_NAME = "FlixBus"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per FlixBus da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-flixbus)"
    }
    try:
